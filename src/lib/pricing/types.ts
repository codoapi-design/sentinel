...
export const CHAIN_MAP: Record<string, ChainMapping> = {
  ...
  metis: { key: 'metis', chainId: 1088, defillama: 'metis', coingeckoPlatform: 'metis-andromeda', alchemyNetwork: 'metis-mainnet', nativeCoingeckoId: 'metis-token', nativeSymbol: 'METIS' },
  worldchain: { key: 'worldchain', chainId: 480, defillama: 'worldchain', coingeckoPlatform: 'world-chain', alchemyNetwork: 'worldchain-mainnet', nativeCoingeckoId: 'ethereum', nativeSymbol: 'ETH' },
  unichain: { key: 'unichain', chainId: 130, defillama: 'unichain', coingeckoPlatform: 'unichain', alchemyNetwork: 'unichain-mainnet', nativeCoingeckoId: 'ethereum', nativeSymbol: 'ETH' },
  ink: { key: 'ink', chainId: 57073, defillama: 'ink', coingeckoPlatform: 'ink', alchemyNetwork: 'ink-mainnet', nativeCoingeckoId: 'ethereum', nativeSymbol: 'ETH' },
  soneium: { key: 'soneium', chainId: 1868, defillama: 'soneium', coingeckoPlatform: 'soneium', alchemyNetwork: 'soneium-mainnet', nativeCoingeckoId: 'ethereum', nativeSymbol: 'ETH' },
  abstract: { key: 'abstract', chainId: 2741, defillama: 'abstract', coingeckoPlatform: 'abstract', alchemyNetwork: 'abstract-mainnet', nativeCoingeckoId: 'ethereum', nativeSymbol: 'ETH' },
  sonic: { key: 'sonic', chainId: 146, defillama: 'sonic', coingeckoPlatform: 'sonic', alchemyNetwork: 'sonic-mainnet', nativeCoingeckoId: 'sonic-3', nativeSymbol: 'S' },
  sei: { key: 'sei', chainId: 1329, defillama: 'sei', coingeckoPlatform: 'sei-network', alchemyNetwork: 'sei-mainnet', nativeCoingeckoId: 'sei-network', nativeSymbol: 'SEI' },
  bera: { key: 'bera', chainId: 80094, defillama: 'berachain', coingeckoPlatform: 'berachain', alchemyNetwork: 'berachain-mainnet', nativeCoingeckoId: 'berachain-bera', nativeSymbol: 'BERA' },
  opbnb: { key: 'opbnb', chainId: 204, defillama: 'opbnb', coingeckoPlatform: 'opbnb', alchemyNetwork: 'opbnb-mainnet', nativeCoingeckoId: 'binancecoin', nativeSymbol: 'BNB' },
  apechain: { key: 'apechain', chainId: 33139, defillama: 'apechain', coingeckoPlatform: 'apechain', alchemyNetwork: 'apechain-mainnet', nativeCoingeckoId: 'apecoin', nativeSymbol: 'APE' },
  ronin: { key: 'ronin', chainId: 2020, defillama: 'ronin', coingeckoPlatform: 'ronin', alchemyNetwork: 'ronin-mainnet', nativeCoingeckoId: 'ronin', nativeSymbol: 'RON' },
