...
/**
 * @title RadareumSubscriptionPayments (Remix GitHub imports)
 * @notice Paste THIS file into Remix. Stack-depth safe refactor of the payment flow.
 * @dev Security (v2):
 *  - PaymentIntent.payer is signed; msg.sender must equal payer
 *  - Fee-on-transfer tokens rejected (balance delta must equal amount)
 *  - Referral self-deals via 2 EOAs must be blocked by backend signing policy
 */

import {Ownable} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.2.0/contracts/access/Ownable.sol";
import {Ownable2Step} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.2.0/contracts/access/Ownable2Step.sol";
import {Pausable} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.2.0/contracts/utils/Pausable.sol";
import {ReentrancyGuard} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.2.0/contracts/utils/ReentrancyGuard.sol";
import {EIP712} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.2.0/contracts/utils/cryptography/EIP712.sol";
import {ECDSA} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.2.0/contracts/utils/cryptography/ECDSA.sol";
import {IERC20} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.2.0/contracts/token/ERC20/IERC20.sol";
import {SafeERC20} from "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.2.0/contracts/token/ERC20/utils/SafeERC20.sol";
...
contract RadareumSubscriptionPayments is Ownable2Step, Pausable, ReentrancyGuard, EIP712 {
    ...
    // -------------------------------------------------------------------------
    // Internal — split to avoid "Stack too deep" on Remix without viaIR
    // -------------------------------------------------------------------------
