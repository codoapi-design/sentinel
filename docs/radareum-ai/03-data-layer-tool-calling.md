...
> **Normative.** This part is the engineering Source of Truth for Radareum AI data access and tool calling. Implementation later must follow this architecture. No runtime agents, APIs, or tools are required by this document alone.
