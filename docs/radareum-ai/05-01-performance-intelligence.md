...
> **Normative (Module 01).** Performance Intelligence Engine — first chapter of the Radareum Intelligence Framework. Spec only; no runtime implementation required by this document alone.
