# Radareum AI — Design Spec

This folder holds the **Radareum AI Design Specification**, the engineering **Source of Truth (SoT)** for Radareum AI.
...
2. Resolve table naming conflicts (**Part 6 authoritative**) and map them onto the existing Radareum schema
