...
| **Module 12** | Full Sentinel AI Prompt Package | Forthcoming — **next** |
...
> **Module 10 note:** يعرّف الوكيل (Sentinel Intelligence Agent) بست طبقات، وعشر أدوات، وقواعد منع الهلوسة، وهيكل الاستجابة، والذاكرة، إضافة إلى **§5.165 Final System Prompt** — النسخة **المكثفة القانونية** للتشغيل المشتقة من **Part 4** (الدستور الكامل) + Part 5. عند أي تعارض — **Part 4 يحكم**. كما تبقى **Analysis Modes** في Part 4 §4.20 وأوضاع كل Module سارية معاً.
