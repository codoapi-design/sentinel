...
INSERT INTO content_pages (title, slug, content, meta_description, is_published) VALUES
  ('شروط الاستخدام', 'terms', '<h1>شروط الاستخدام</h1><p>باستخدامك لمنصة Sentinel، فإنك توافق على الشروط والأحكام التالية...</p>', 'شروط استخدام منصة Sentinel لمراقبة المحافظ الرقمية', true),
  ('سياسة الخصوصية', 'privacy', '<h1>سياسة الخصوصية</h1><p>نحن في Sentinel نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية...</p>', 'سياسة خصوصية منصة Sentinel', true),
  ('الأسئلة الشائعة', 'faq', '<h1>الأسئلة الشائعة</h1><h2>ما هي Sentinel؟</h2><p>Sentinel هي منصة متقدمة لمراقبة وإدارة المحافظ الرقمية...</p>', 'الأسئلة الشائعة حول منصة Sentinel', true)
